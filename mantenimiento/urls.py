...
from .views import RegistrarMantenimientoView,ListarMantenimientosView,ActualizarMantenimientoView,EliminarMantenimientoView, ListarFavoritosView, ListaTalleresView, EliminarFavoritoView,AgregarFavoritoView
